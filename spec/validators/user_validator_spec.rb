...
describe UserValidator, type: :service do
  ...
  context 'for invalid password length' do
    let(:params) { { username: 'username', password: '1234qwe', password_confirmation: '1234qwe' } }
  ...
  context 'for not equal passwords' do
    let(:params) { { username: 'username', password: '1234qweR', password_confirmation: '1234qwer' } }
